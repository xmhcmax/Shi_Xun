...
bool searchCertainData(time_t timeLow,time_t timeHigh,int dataPos){
    ...
    //其中offsite1[0]是该种数据第一个的偏移
    //offsite1[1]是最后一个数据结尾处的偏移（不是最后一个数据的偏移）
    //offsite1[2]是该类数据的大小
    int offsite1[3];
    ...
    for(startPos1;startPos1<endPos1;startPos1+=offsite1[2]){
        ...
        case 1:
            //读取int类型
            fin1.read((char*)&intData,offsite1[2]);
            cout<<intData<<endl;
            break;
        case 2:
            //读取char类型
            fin1.read((char*)&charData,offsite1[2]);
            cout<<charData<<endl;
            break;
        case 3:
            //读取bool类型
            fin1.read((char*)&boolData,offsite1[2]);
            cout<<boolData<<endl;
            break;
        case 4:
            //读取float类型
            fin1.read((char*)&floatData,offsite1[2]);
            cout<<floatData<<endl;
            break;
        case 5:
            //读取double类型
            fin1.read((char*)&doubleData,offsite1[2]);
    ...
    while(1){
        ...
        if(fileName==lastFileName){
            ...
            for(startPos2;startPos2<endPos2;startPos2+=offsite2[2]){
                ...
                case 1:
                    //读取int类型
                    fin2.read((char*)&intData,offsite2[2]);
                    cout<<intData<<endl;
                    break;
                case 2:
                    //读取char类型
                    fin2.read((char*)&charData,offsite2[2]);
                    cout<<charData<<endl;
                    break;
                case 3:
                    //读取bool类型
                    fin2.read((char*)&boolData,offsite2[2]);
                    cout<<boolData<<endl;
                    break;
                case 4:
                    //读取float类型
                    fin2.read((char*)&floatData,offsite2[2]);
                    cout<<floatData<<endl;
                    break;
                case 5:
                    //读取double类型
                    fin2.read((char*)&doubleData,offsite2[2]);
                    cout<<doubleData<<endl;
                    break;
                }
            }
    ...
    for(startPos3;startPos3<endPos3;startPos3+=offsite3[2]){
        ...
        case 1:
            //读取int类型
            fin3.read((char*)&intData,offsite3[2]);
            cout<<intData<<endl;
            break;
        case 2:
            //读取char类型
            fin3.read((char*)&charData,offsite3[2]);
            cout<<charData<<endl;
            break;
        case 3:
            //读取bool类型
            fin3.read((char*)&boolData,offsite3[2]);
            cout<<boolData<<endl;
            break;
        case 4:
            //读取float类型
            fin3.read((char*)&floatData,offsite3[2]);
            cout<<floatData<<endl;
            break;
        case 5:
            //读取double类型
            fin3.read((char*)&doubleData,offsite3[2]);
            cout<<doubleData<<endl;
            break;
        }
    }
...
int main(){
    ...
    time_t timeLow=1661686688;
    time_t timeHigh=1661686891;
